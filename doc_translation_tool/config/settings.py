...
def load_app_settings(
    ...
    return AppSettings(
        ...
        llm=LLMSettings(
            ...
            timeout=_to_int(merged_llm.get("timeout"), 60),
            connect_timeout=_to_int(merged_llm.get("connect_timeout"), 10),
            read_timeout=_to_int(merged_llm.get("read_timeout"), 60),
            max_retries=_to_int(merged_llm.get("max_retries"), 2),
            batch_size=_to_int(merged_llm.get("batch_size"), 8),
            parallel_batches=_to_int(merged_llm.get("parallel_batches"), 2),
            temperature=_to_float(merged_llm.get("temperature"), 0.2),
            max_tokens=_to_optional_int(merged_llm.get("max_tokens")),
        ),
