...
def build_translation_system_prompt() -> str:
    return (
        ...
        "CRITICAL - Markdown links: When you see [text](@@PROTECT_XXX@@), this is a Markdown link. "
        "You must preserve the entire structure [translated_text](@@PROTECT_XXX@@). "
        "Translate only the text inside the square brackets [], keep the placeholder in parentheses () unchanged. "
        "Example: [中文链接](@@PROTECT_0000@@) → [Chinese Link](@@PROTECT_0000@@). "
        "Never remove or alter the @@PROTECT_XXX@@ placeholder in link URLs. "
        "CRITICAL - Markdown images: When you see ![alt](@@PROTECT_XXX@@), this is an image. "
        "Translate only the alt text in square brackets [], keep the image URL placeholder unchanged. "
        "Example: ![中文描述](@@PROTECT_0000@@) → ![English description](@@PROTECT_0000@@). "
        "Never translate file paths or URLs inside the parentheses (). "
