...
# Optimized regex patterns - using pre-compiled patterns from utils
_URL_LIKE_RE = URL_PATTERN
...
class DitaDocumentHandler(DocumentHandler):
    ...
    def _create_secure_parser(self) -> XMLParser:
        ...
        class SecureXMLParser(XMLParser):
            ...
            def entity(self, decl: tuple[str, str | None, str | None, str | None]) -> None:
                return None
    ...
    def prepare_document(
        ...
        *,
        ...
        root = ET.fromstring(source_text, parser=parser)
        leading_xml_text = self._extract_leading_xml_text(source_text)
        namespace_map = self._extract_namespace_map(source_text)
    ...
    def rebuild_document(
        ...
        parser = self._create_secure_parser()
        root = ET.fromstring(document.source_text, parser=parser)
        ...
        self._register_namespace_map(document.namespace_map)
    ...
    def extract_language_detection_text(self, source_text: str) -> str:
        try:
            ...
            logger.warning(f"Failed to parse DITA XML for language detection: {e}")
            return source_text
    ...
    def _local_name(self, tag: object) -> str | None:
    ...
    def _extract_namespace_map(self, source_text: str) -> dict[str, str]:
    ...
    def _register_namespace_map(self, namespace_map: dict[str, str]) -> None:
    ...
    def _protect_text_literals(
        ...
        # Protect URLs and paths using regex patterns
        for pattern, kind in (
